...
external_url 'https://git.run' #RUN#
...
################################################################################
gitlab_rails['gitlab_ssh_host'] = 'git.run' #RUN#
...
gitlab_rails['smtp_enable'] = false #RUN#
...
gitlab_rails['gitlab_email_enabled'] = false #RUN#
...
### Gravatar Settings
# gitlab_rails['gravatar_plain_url'] = 'http://cdn.sep.cc/avatar/%{hash}?s=%{size}&d=identicon'
...
gitlab_rails['incoming_email_enabled'] = false #RUN#
...
### Git LFS
gitlab_rails['lfs_enabled'] = true #RUN#
...
gitlab_rails['terraform_state_enabled'] = false #RUN#
...
### Usage Statistics
gitlab_rails['usage_ping_enabled'] = false #RUN#
...
gitlab_rails['gitlab_shell_ssh_port'] = 2222 #RUN#
...
registry_external_url 'https://cr.git.run' #RUN#

### Settings used by GitLab application
gitlab_rails['registry_enabled'] = true #RUN#
gitlab_rails['registry_host'] = "cr.git.run" #RUN#
...
registry['enable'] = true #RUN#
# registry['username'] = "registry"
# registry['group'] = "registry"
# registry['uid'] = nil
# registry['gid'] = nil
# registry['dir'] = "/var/opt/gitlab/registry"
registry['registry_http_addr'] = "0.0.0.0:5000" #RUN#
...
################################################################################
gitlab_rails['sentry_enabled'] = false #RUN#
...
# puma['enable'] = true
# puma['ha'] = false
puma['worker_timeout'] = 30 #RUN#
puma['worker_processes'] = 0 #RUN#
puma['min_threads'] = 1 #RUN#
puma['max_threads'] = 2 #RUN#
...
postgresql['shared_buffers'] = "128MB" #run#
...
postgresql['max_worker_processes'] = 5 #RUN#
...
nginx['listen_port'] = 80 #RUN#

##! **Override only if your reverse proxy internally communicates over HTTP**
##! Docs: https://docs.gitlab.com/omnibus/settings/nginx.html#supporting-proxied-ssl
nginx['listen_https'] = false #RUN#
...
gitlab_ci['gitlab_ci_all_broken_builds'] = false #RUN#
gitlab_ci['gitlab_ci_add_pusher'] = false #RUN#
...
gitlab_rails['gitlab_kas_enabled'] = false #RUN#
...
mattermost_nginx['enable'] = false #RUN#
...
monitoring_role['enable'] = false #RUN#

prometheus['enable'] = false #RUN#
...
node_exporter['enable'] = false #RUN#
...
redis_exporter['enable'] = false #RUN#
...
postgres_exporter['enable'] = false #RUN#
...
pgbouncer_exporter['enable'] = false #RUN#
...
gitlab_exporter['enable'] = false #RUN#
...
prometheus_monitoring['enable'] = false #RUN#
...
grafana['reporting_enabled'] = false #RUN#
...
gitlab_rails['kerberos_enabled'] = false #RUN#
...
gitlab_rails['packages_enabled'] = false #RUN#
...
gitlab_rails['dependency_proxy_enabled'] = false #RUN#
